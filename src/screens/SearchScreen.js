...
import { getRecipesByKeyword, getRecipesByIngredients } from "../store/recipeSlice";
...
export default function SearchScreen({ navigation }) {
  ...
  const handleSearch = () => {
    ...
    if (keyword.trim() !== "") {
      ...
      dispatch(getRecipesByKeyword(keyword));
    }
  };
  ...
  const handleIngredientSearch = () => {
    ...
    if (ingredientText.trim() !== "") {
      ...
      dispatch(getRecipesByIngredients(list));
    }
  };
  ...
  const handleCategoryPress = (category) => {
    ...
    dispatch(getRecipesByKeyword(category));
  };
...
const styles = StyleSheet.create({
  screen: {
    ...
    width: "100%", 
    // Removed alignItems: 'center' to prevent overflow issues
  },
  webContainer: {
    width: "100%",
    maxWidth: 500,
    alignSelf: "center", // This centers the container safely
    flex: 1,
  },
  listContent: {
    padding: 16,
